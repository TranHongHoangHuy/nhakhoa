    ...
    <div className="min-h-screen bg-white border-r">
      {aToken && (
        <ul className="text-[#515151] mt-5">
          {aToken !==
            "eyJhbGciOiJIUzI1NiJ9.bmhhbnZpZW5AZ21haWwuY29tMTIzNDU2Nzg5.X50HKqcCT48nLV1sMwwHGT0jB3c9ev0RWAUjUYB8t18" && (
            <NavLink
              to={"/admin-dashboard"}
              className={({ isActive }) =>
          ...
          >
            <img className="min-w-5" src={assets.feedback_icon} alt="" />
            <p className="hidden md:block">Phản hồi</p>
          </NavLink>
        </ul>
      )}
